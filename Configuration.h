...
struct Configuration {
	...
	string TrafficPath="./scratch/RA_AMC/config/data-1-1.0.txt";
	bool S1g1MfieldEnabled=false;
	string RAWConfigFile = "./scratch/RA_AMC/config/RawConfig-rca.txt";
	string DataMode = "MCS2_0"; //TODO copy this from Dwight, OfdmRate7_8MbpsBW2MHz MCS2
	string OutputPath = "./scratch/RA_AMC/dist";
	/*
